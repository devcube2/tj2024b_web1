		...
		<div class="row align-items-center g-lg-5 py-5">
			...
			<div class="col-md-10 mx-auto col-lg-5">
				<form id="signupform" class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
					...
					<hr class="my-4">
					<small class="text-body-secondary"><a href="#">아이디찾기</a></small>
					<small class="text-body-secondary"><a href="#">비밀번호찾기</a></small>
				</form>
			</div>
		</div>
	</div>

	<script type="text/javascript" src="/tj2024b_web1/js/member/signup.js"></script>"
